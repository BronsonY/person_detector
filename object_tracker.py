...
alarm_sound_file = 'sound/beep-warning-6387.mp3'  # Replace with the path to your alarm sound file
...
def Object_tracking(Yolo, video_path, output_path, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors='', Track_only=["person"]):
...
Object_tracking(yolo, video_path, "detection2.mp4", input_size=YOLO_INPUT_SIZE, show=True, iou_threshold=0.1, rectangle_colors=(255,0,0), Track_only = ["person"])
