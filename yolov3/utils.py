...
def draw_bbox(image, bboxes, CLASSES=YOLO_COCO_CLASSES, show_label=True, show_confidence=True, Text_colors=(255, 255, 0),
        ...
        if len(bbox) >= 6:
            ...
            if show_label:
                ...
                try:
                    ...
                    print(
                        "while using custom classes, if using a custom model in configs.py set YOLO_CUSTOM_WEIGHTS = True")
